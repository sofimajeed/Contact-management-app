...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-16 text-gray-50   p-4  w-full ">
            <div className="m-4">
                <button className="rounded-full bg-violet-600 p-2 text-2xl create-contact">
            ...
            {AllContacts.length == 0 && <div className=" m-auto w-fit p-4 align-middle text-blue-500 justify-center">
                ...
                <h1 className="text-3xl">No Contacts Found</h1>
            </div>}
            <div id="contact_list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">

                {
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-yellow-950 rounded-lg shadow-md m-4 p-4 text-white">
                            ...
                            <div className="flex justify-between my-2 buttons">
                                <Link to={`edit/${el.id}`}>
                                    <button className="rounded p-2 edit-btn bg-violet-600 text-white">
                                        Edit
                                    </button>
                                </Link>
                                <button className="rounded p-2 bg-green-600 text-pink" onClick={() => togglePopup(el)} >View</button>
